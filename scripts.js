const bossDetails = {
  ...
  "Caballero Artorias": {
    ...
    moves: [
      ...
      { name: "Salto Mortal con Golpe Aplastante", description: "A media distancia, Artorias salta con agilidad hacia el jugador para asestar un contundente golpe descendente con su espada, repitiendo el ataque hasta tres veces mientras se adapta a la posición del oponente. Es fundamental esquivar o bloquear el primer impacto, ya que los golpes posteriores dejan aturdido al jugador y, si su peso supera la mitad de su carga, pueden derribarlo, dificultando la huida. No se recomienda atacar tras evadir el primer golpe, pues Artorias podría replicar con una contragolpe similar a su <a href="">Carga Puñalada</a>. Sin embargo, bloquear los tres saltos permite aprovechar el tiempo en que recupera lentamente su postura. Cabe resaltar que este ataque ignora por completo la invulnerabilidad, lo que implica que la espada dañará al jugador incluso durante una esquiva o estando en el suelo; la mejor defensa es rodar lateralmente." },
